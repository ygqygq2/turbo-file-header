...
const testInfo: TestInfo = [
  {
    ...
    files: [
      ...
      { fileName: 'function-optional-params-without-return-type-update.ts', cursorLine: 0 },
      { fileName: 'function-optional-params-without-return-type.ts', cursorLine: 0 },
